...
class MainWindow(QMainWindow):
    ...
    def _build_workspace_page(self) -> QWidget:
        ...
        launch_helper = QLabel("Launch a new scan for the current session.")
        ...
        center_layout.addWidget(self._wrap_group("Launch", launch_panel))
    ...
    def _build_runs_page(self) -> QWidget:
        ...
        layout.addWidget(self._wrap_group("Run Actions", controls_panel))
    ...
    def _apply_restore_geometry(self, available_geometry: QRect | None = None) -> None:
        ...
        if geometry.isNull():
            ...
            return
        width = self._fit_restore_dimension(1280, geometry.width(), 0.72, 680)
        height = self._fit_restore_dimension(840, geometry.height(), 0.74, 520)
        self.resize(width, height)
        frame = self.frameGeometry()
        frame.moveCenter(geometry.center())
        self.move(frame.topLeft())
